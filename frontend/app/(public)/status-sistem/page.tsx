  ...
  return (
    <div className="max-w-2xl mx-auto py-12 space-y-6">
      <div className="text-center space-y-2">
        ...
        <p className="text-xs text-slate-500">Infrastruktur Database Spatial & Serverless API Status</p>
      </div>
      ...
      <Card className="p-6 space-y-3 text-xs">
        <div className="flex justify-between items-center p-3 bg-emerald-50 rounded-xl border border-emerald-200">
          <span className="font-medium text-slate-800">PostgreSQL + PostGIS Spatial Engine</span>
        ...
        <div className="flex justify-between items-center p-3 bg-emerald-50 rounded-xl border border-emerald-200">
          <span className="font-medium text-slate-800">Realtime WebSockets Channel</span>
          <span className="font-bold text-emerald-800 flex items-center gap-1.5">
