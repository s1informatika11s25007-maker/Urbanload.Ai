      ...
      <div className="h-64 w-full">
         width="100%" height="100%">
           data={data}>
             ...
             dataKey="jam" tick={{ fontSize: 11 }} />
             domain={[0, 10]} tick={{ fontSize: 11 }} />
             />
             type="monotone" dataKey="zonaA" name="Zona A (Tanah Abang)" stroke="#ef4444" strokeWidth={3} />
             type="monotone" dataKey="zonaB" name="Zona B (Monas)" stroke="#eab308" strokeWidth={2} />
             type="monotone" dataKey="zonaC" name="Zona C (Tg. Priok)" stroke="#22c55e" strokeWidth={2} />
          </LineChart>
        </ResponsiveContainer>
      </div>
    </Card>
