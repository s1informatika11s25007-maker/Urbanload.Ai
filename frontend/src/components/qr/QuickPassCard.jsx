...
export function QuickPassCard({ bookingId = 'UL-2025-091823', zone = 'Zona A - Pasar Tanah Abang' }: any) {
  ...
  return (
     className="max-w-[420px] mx-auto p-6 text-center shadow-xl border-slate-200 rounded-2xl bg-white">
      ...
      <div className="my-4 flex justify-center p-4 bg-slate-50 rounded-2xl border border-slate-100 relative">
         value={`https://urbanload.ai/verify?booking=${bookingId}&sig=hmac256_sig`} size={280} />
      </div>
      ...
      <div className="space-y-1.5 text-slate-800">
        ...
        <div className="text-xs font-medium text-slate-600">Waktu: 14:00 – 15:00 WIB · No. Truk 1234 XYZ</div>
      </div>
