...
export default function FeatureGeofence() {
  return (
      ...
      <Card className="p-8 space-y-6 border-slate-200 shadow-md">
        <div className="p-6 rounded-2xl bg-amber-50 border border-amber-200 space-y-3 text-xs">
          ...
          <p className="text-amber-800 leading-relaxed">
            Penggambaran dan pengubahan poligon batas zona logistik kota adalah fitur sensitif yang hanya dapat dilakukan oleh <strong>Admin Pengelola Kota</strong> untuk menjaga keamanan data tata ruang kota.
          </p>
          <div className="pt-2">
            <Link to="/login">
              <Button className="text-xs py-2 px-4 flex items-center gap-1.5 font-bold">
