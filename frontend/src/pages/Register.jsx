...
export default function Register() {
  ...
  return (
    <div className="min-h-[calc(100vh-64px)] w-full flex flex-col lg:flex-row bg-slate-950 text-white">
      {/* KIRI: Brand Showcase & Feature Highlights (Laptops/Desktops) */}
      <div className="hidden lg:flex w-1/2 bg-gradient-to-br from-slate-950 via-teal-950 to-slate-900 p-12 flex-col justify-between relative overflow-hidden border-r border-slate-800">
        ...
        <div className="relative z-10 space-y-3">
          ...
          <p className="text-xs text-slate-400 max-w-md">
            Registrasi Realtime Akun Pengendali Logistik & Kuota Loading Bay Perkotaan
          </p>
        </div>
        ...
        <div className="relative z-10 space-y-6 my-auto max-w-lg">
          <div className="space-y-2">
            <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[11px] font-extrabold bg-teal-500/20 text-teal-300 border border-teal-500/30">
              <Shield className="h-3.5 w-3.5 text-teal-400" /> Ekosistem Terverifikasi
            </span>
          ...
          <div className="space-y-3 pt-2 text-xs">
            <div className="flex items-center gap-3 p-3 rounded-2xl bg-slate-900/80 border border-slate-800">
              ...
              <div>
                <span className="font-bold text-white block">Registrasi Otomatis & Terverifikasi</span>
                <span className="text-[11px] text-slate-400">Integrasi OTP WhatsApp & Email verifikasi instan</span>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 p-3 rounded-2xl bg-slate-900/80 border border-slate-800">
              ...
              <div>
                <span className="font-bold text-white block">Akses Langsung Fitur SmartSlot AI</span>
                <span className="text-[11px] text-slate-400">Rekomendasi slot waktu bebas hambatan & penalti StrikeBan</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="relative z-10 p-4 rounded-2xl bg-slate-900/90 border border-slate-800 backdrop-blur-xl flex items-center justify-between">
          ...
          <span className="text-[10px] font-mono bg-teal-500/20 text-teal-300 px-2.5 py-1 rounded-full border border-teal-500/30">
            Aman & Enkripsi HMAC-SHA256
          </span>
        </div>
      </div>

      {/* KANAN: Form Pendaftaran (Full Width di Mobile Android, Half Width di Laptop) */}
            ...
            <div className="grid grid-cols-3 gap-2 bg-slate-100 p-1.5 rounded-2xl border border-slate-200">
              <button
                ...
                className={`py-2.5 px-1 rounded-xl text-xs font-black flex items-center justify-center gap-1.5 transition-all duration-150 ${
                  role === 'rider'
                    ? 'bg-teal-600 text-white shadow-lg ring-2 ring-teal-600/30'
