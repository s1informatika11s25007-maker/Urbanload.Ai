...
export function CongestionCard({ name, score, active, capacity }: Props) {
  ...
  return (
    <Card className="p-5 hover:shadow-md transition bg-white border-slate-200">
      ...
      <div className="mt-4 border-t border-slate-100 pt-3 flex justify-between items-center text-xs text-slate-500">
        ...
        <span className="cursor-help flex items-center gap-1 hover:text-teal-600 transition" title="Rumus Rule-Based: Skor = ceil((booking_aktif / kapasitas_maks) * 10)">
