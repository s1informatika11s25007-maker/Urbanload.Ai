...
export function QRScanner({ onScan }: { onScan: (data: string) => void }) {
  ...
  return (
    <Card className="p-6 border-slate-300 bg-slate-50">
      <h4 className="text-sm font-bold text-slate-800 mb-3">Kamera Scanner QR & Input Manual (Role: Dishub)</h4>
      ...
      <div className="flex gap-2">
        ...
        />
        <Button onClick={() => onScan(manualId || 'UL-2025-091823')} className="text-xs">
          Verifikasi QR
        </Button>
      </div>
    </Card>
